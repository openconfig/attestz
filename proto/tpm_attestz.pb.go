...
type AttestResponse_AttestationCert_AikCert struct {
	AikCert string `protobuf:"bytes,1,opt,name=aik_cert,json=aikCert,proto3,oneof"` // TPM 1.2
}

type AttestResponse_AttestationCert_OiakCert struct {
	OiakCert string `protobuf:"bytes,2,opt,name=oiak_cert,json=oiakCert,proto3,oneof"` // TPM 2.0
}
