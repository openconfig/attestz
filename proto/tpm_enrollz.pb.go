...
// Type of TPM restricted key. These can be used for enrollment with TPM 2.0.
type Key int32
...
func (x *GetIakCertRequest) GetHashAlgo() Tpm20HashAlgo {
	...
	return Tpm20HashAlgo_TPM_2_0_HASH_ALGO_UNSPECIFIED
}
...
type GetIakCertResponse struct {
	...
	// Optional: If atomic oIAK/oIDevID rotation is supported, return true.
...
type RotateOIakCertRequest struct {
	...
	// List of control cards that need to update their owner Initial Attestation
	// Key (oIAK) and Initial DevID (oIDevID) certificates.
...
// Information needed for a given control card to update its owner Initial
// Attestation Key (oIAK) and Initial DevID (oIDevID) certificates signed by the
// network device owner/administrator CA.
...
// Request to get vendor identity fields of the selected control card.
...
// Response to GetControlCardVendorIDRequest.
...
type GetIdevidCsrRequest struct {
	...
	// Switch control card selected identifier.
	ControlCardSelection *ControlCardSelection `protobuf:"bytes,1,opt,name=control_card_selection,json=controlCardSelection,proto3" json:"control_card_selection,omitempty"`
	// Type of key to be used for enrollment. The verifier checks that the public
	// portion of this key exists in a Root of Trust.
...
// Response paramateres for GetIdevidCsrRequest.
// protolint:disable MAX_LINE_LENGTH
// https://trustedcomputinggroup.org/wp-content/uploads/TPM-2.0-Keys-for-Device-Identity-and-Attestation-v1.10r9_pub.pdf#page=70
type CsrResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// TCG-IDEVID-CSR contents.
	CsrContents []byte `protobuf:"bytes,1,opt,name=csr_contents,json=csrContents,proto3" json:"csr_contents,omitempty"`
	// signature over csr_contents using IDevID.
...
type HMACChallenge struct {
	...
	// The seed for the import of the restricted HMAC key under the EK
...
// Request to challenge the TPM with an HMAC wrapped to the EK public key.
type ChallengeRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Switch control card selected identifier.
	ControlCardSelection *ControlCardSelection `protobuf:"bytes,1,opt,name=control_card_selection,json=controlCardSelection,proto3" json:"control_card_selection,omitempty"`
	// Type of key device must decrypt encrypted_nonce with.
...
type HMACChallengeResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The attested IAK public area (TPM2B_PUBLIC contents)
	...
	// The signature over the iak_certify_info using HMAC
	// (TPMT_SIGNATURE contents)
...
// Response containing the IAK pub key and HMAC-signed Certification of IAK.
...
const file_github_com_openconfig_attestz_proto_tpm_enrollz_proto_rawDesc = "" +
	...
	"\x14idevid_signature_csr\x18\x02 \x01(\fR\x12idevidSignatureCsr\"\xeb\x01\n" +
	"\x14GetIdevidCsrResponse\x12O\n" +
	"\x0fcontrol_card_id\x18\x01 \x01(\v2'.openconfig.attestz.ControlCardVendorIdR\rcontrolCardId\x12B\n" +
	"\fcsr_response\x18\x04 \x01(\v2\x1f.openconfig.attestz.CsrResponseR\vcsrResponse\x122\n" +
	"\x06status\x18\x05 \x01(\x0e2\x1a.openconfig.attestz.StatusR\x06statusJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04\"o\n" +
	"\rHMACChallenge\x12 \n" +
	"\fhmac_pub_key\x18\x01 \x01(\fR\n" +
	"hmacPubKey\x12\x1c\n" +
	"\tduplicate\x18\x02 \x01(\fR\tduplicate\x12\x1e\n" +
	"\vin_sym_seed\x18\x03 \x01(\fR\tinSymSeed\"\xe4\x01\n" +
	"\x10ChallengeRequest\x12^\n" +
	"\x16control_card_selection\x18\x01 \x01(\v2(.openconfig.attestz.ControlCardSelectionR\x14controlCardSelection\x12)\n" +
	"\x03key\x18\x03 \x01(\x0e2\x17.openconfig.attestz.KeyR\x03key\x12?\n" +
	"\tchallenge\x18\x04 \x01(\v2!.openconfig.attestz.HMACChallengeR\tchallengeJ\x04\b\x02\x10\x03\"\x97\x01\n" +
	...
	"\x1aiak_certify_info_signature\x18\x03 \x01(\fR\x17iakCertifyInfoSignature\"k\n" +
	"\x11ChallengeResponse\x12P\n" +
	"\x0echallenge_resp\x18\x01 \x01(\v2).openconfig.attestz.HMACChallengeResponseR\rchallengeRespJ\x04\b\x02\x10\x03*3\n" +
	"\x03Key\x12\x13\n" +
