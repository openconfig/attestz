...
type GetIakCertRequest struct {
	...
	UseAtomicCertRotation bool                                     `protobuf:"varint,4,opt,name=use_atomic_cert_rotation,json=useAtomicCertRotation,proto3" json:"use_atomic_cert_rotation,omitempty"`
...
func (x *GetIakCertRequest) GetUseAtomicCertRotation() bool {
	if x != nil {
		return x.UseAtomicCertRotation
	}
	return false
}
...
const file_github_com_openconfig_attestz_proto_tpm_enrollz_proto_rawDesc = "" +
	"\n" +
	"5github.com/openconfig/attestz/proto/tpm_enrollz.proto\x12\x12openconfig.attestz\x1a<github.com/openconfig/attestz/proto/common_definitions.proto\"\xa4\x02\n" +
	...
	"\thash_algo\x18\x03 \x01(\x0e2!.openconfig.attestz.Tpm20HashAlgoH\x01R\bhashAlgo\x88\x01\x01\x127\n" +
	"\x18use_atomic_cert_rotation\x18\x04 \x01(\bR\x15useAtomicCertRotationB\b\n" +
	"\x06_nonceB\f\n" +
	"\n" +
	"_hash_algo\"\xe3\x01\n" +
