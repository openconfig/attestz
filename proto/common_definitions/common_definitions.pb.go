...
type ControlCardSelection struct {
	...
	// Types that are assignable to ControlCardId:
	//
...
func (m *ControlCardSelection) GetControlCardId() isControlCardSelection_ControlCardId {
	if m != nil {
		return m.ControlCardId
	}
	return nil
}

func (x *ControlCardSelection) GetRole() ControlCardRole {
	if x, ok := x.GetControlCardId().(*ControlCardSelection_Role); ok {
		return x.Role
	}
	return ControlCardRole_CONTROL_CARD_ROLE_UNSPECIFIED
}
...
func (x *ControlCardSelection) GetSerial() string {
	if x, ok := x.GetControlCardId().(*ControlCardSelection_Serial); ok {
		return x.Serial
	}
	return ""
}
...
func (x *ControlCardSelection) GetSlot() string {
	if x, ok := x.GetControlCardId().(*ControlCardSelection_Slot); ok {
		return x.Slot
	}
	return ""
}
...
var file_github_com_openconfig_attestz_proto_common_definitions_proto_goTypes = []interface{}{
...
func file_github_com_openconfig_attestz_proto_common_definitions_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_openconfig_attestz_proto_common_definitions_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ControlCardVendorId); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_openconfig_attestz_proto_common_definitions_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ControlCardSelection); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_github_com_openconfig_attestz_proto_common_definitions_proto_msgTypes[1].OneofWrappers = []interface{}{
