	...
	tests := []struct {
	...
	}{
		{
			...
			req: &VerifyNonceSignatureReq{
				...
				Nonce:     nonce,
				HashAlgo:  apb.Tpm20HashAlgo_TPM20HASH_ALGO_SHA256,
			},
		...
		},
		{
			...
			req: &VerifyNonceSignatureReq{
				...
				Nonce:     nonce,
				HashAlgo:  apb.Tpm20HashAlgo_TPM20HASH_ALGO_SHA384,
			},
			wantResp: &VerifyNonceSignatureResp{IsValid: true},
			wantErr:  false,
		},
		...
		},
		{
			...
			req: &VerifyNonceSignatureReq{
				...
				Nonce:     nonce,
				HashAlgo:  apb.Tpm20HashAlgo_TPM20HASH_ALGO_SHA512,
			},
			wantResp: &VerifyNonceSignatureResp{IsValid: true},
			wantErr:  false,
		},
		...
		},
		{
			...
			req: &VerifyNonceSignatureReq{
				...
				Signature: rsaSHA256Sig,
				Nonce:     nonce,
				HashAlgo:  apb.Tpm20HashAlgo_TPM20HASH_ALGO_UNSPECIFIED,
			},
			wantResp: nil,
			wantErr:  true,
		},
